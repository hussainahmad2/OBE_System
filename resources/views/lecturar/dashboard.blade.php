                        ...
                        <tbody>
                            @forelse($CourseAllocations as $Course)
                                <tr>
                                    ...
                                    <td>
                                       {{-- <a  class="btn btn-primary btn-sm" href="{{ route('courses.AllRegisteredStudent' , $Course->course_id) }}">View All</button> --}}
                                        <a class="btn btn-primary btn-sm" href="{{ route('courses.setCourseSession', $Course->course_id) }}">View All</a>

                                        {{-- <form class="m-0 p-0" style="box-shadow:none; background:none;"method="GET" action="{{ route('courses.AllRegisteredStudent') }}">
                                            <input type="hidden" name="course" value="{{ $Course->course_id }}">
                                            <input type="hidden" name="faculty" value="{{ auth()->user()->id }}">
