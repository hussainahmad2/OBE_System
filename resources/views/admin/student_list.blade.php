    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 mt-4 px-4">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <h2 class="mb-0" style="font-weight: 600; color: #2c3e50;">Student List</h2>
                <form method="GET" action="{{ route('student.list') }}" class="search-container mt-3 mt-md-0" style="max-width: 350px; width: 100%;">
                    <input type="text" id="studentSearch" name="search" placeholder="Search students..." value="{{ request('search') }}" autocomplete="off" />
            ...
            <div class="table-responsive">
                <table id="studentTable" class="faculty-table">
                    <thead>
                        <tr>
                            <th>Reg No</th>
                            <th>Name</th>
